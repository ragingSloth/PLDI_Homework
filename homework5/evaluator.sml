...
structure Evaluator = struct
  ...
  fun primHd [I.VList (ref l::ll)] = l
    | primHd _ = evalError ["primHd"]

  fun primTail [I.VList (l::ll)] = I.VList ll
    | primTail _ = evalError ["primTail"]

  fun primUHd [I.VList (l::ll), b] = l:=b
    | primUHd _ = evalError ["primUHd"]
  ...
  val initialEnv = 
      [("+", Func (["a","b"], I.EPrimCall (primPlus,
       ...
       ("hd", Func (["a"],I.EPrimCall (primHd,
                       [I.EIdent "a"]),
                       [])),
       ("tl", Func (["a"],I.EPrimCall (primTail,
                       [I.EIdent "a"]),
                       [])),
       ("updateHd", Proc (["a","b"],I.SPrimCall (primUHd,
